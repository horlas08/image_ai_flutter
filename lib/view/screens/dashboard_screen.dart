...
final bottomView = [History(), Profile()];
...
class _DashboardScreenState extends State<DashboardScreen> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      onPressed: (pickedFile != null && style != null)
                          ? submit
                          : null,
  ...
  Widget build(BuildContext context) {
    ...
    final billing = Get.find<BillingController>();
    final showChrome =
        auth.isLoggedIn.value; // hide appbar & bottom nav for guests
    return Scaffold(
      ...
      bottomNavigationBar: showChrome
          ...
          : AnimatedBottomNavigationBar.builder(
              ...
              rightCornerRadius: 0,
              hideAnimationCurve: ElasticInOutCurve(),
              onTap: (index) => index == 0 ? null: Get.toNamed(RoutesName.login),
              //other params
            ),
      body: Column(
        children: [
          ...
          Obx(
            () => (billing.isPro.value || !showChrome)
