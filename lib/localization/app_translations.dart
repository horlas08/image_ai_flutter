...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en': {
          ...
          'three_day_trial': '3 DAYS FREE TRIAL',
          'free': 'FREE',
          'no_payment_now': 'No payment now',
          'buy_now': 'Buy Now',
          'unlimited_access_title': 'Remodel with\nUnlimited Access',
          'locked_transformations': 'Locked Transformations',
        ...
        'ar': {
          ...
          'best_offer': 'أفضل عرض',
          'three_day_trial': 'تجربة مجانية لمدة 3 أيام',
          'free': 'مجانًا',
          'no_payment_now': 'لا يوجد دفع الآن',
          'buy_now': 'اشترِ الآن',
          'unlimited_access_title': 'أعد التصميم مع\nوصول غير محدود',
          'locked_transformations': 'تحويلات مقفلة',
          'high_quality': 'جودة عالية',
          'fast_generation': 'توليد سريع',
          'free_trial_enabled': 'تم تفعيل التجربة المجانية',
